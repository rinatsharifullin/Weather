...
function getWeather(){
    ...
    $.getJSON(getIP).done(function(location) {
        $.getJSON(openWeatherMap, {
            ...
            $("#weather-icon").attr("href",'https://openweathermap.org/img/wn/' + result.weather[0].icon + '@2x.png');
            $('#icon1').attr('src', 'https://openweathermap.org/img/wn/' + result.weather[0].icon + '@2x.png');
